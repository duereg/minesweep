...
(function(ko, amplify, undefined) {
	...
	function valueViewModel(column, row) {
		...
		this.getValueColor = ko.computed(function() { return colors[this.value()]; }, this);
		this.fontSizeInPixels = ko.computed(function() { return this.size() - 4 + "px"; }, this);
		this.isValue = ko.computed(function() { return !this.isCovered() && !this.isTagged(); }, this); 
