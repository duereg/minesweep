...
(function(ko, amplify, undefined) {
	...
	var gameViewModel = function(config, maxRows, maxColumns) {
		...
		this.maxMines = ko.computed(function() { return me.columns() * me.rows(); });
		this.tilesLeft = ko.computed(function() { return me.tilesCovered() - me.minesTagged(); });
		this.tooFewMines = ko.computed(function() { return me.numMines() < 1; });
		this.tooFewColumns = ko.computed(function() { return me.columns() < 2; });
		this.tooFewRows = ko.computed(function() { return me.rows() < 2; });
		this.tooManyColumns = ko.computed(function() { return me.columns() > me.maxColumns; });
		this.tooManyRows = ko.computed(function() { return me.rows() > me.maxRows; });
		this.allTagsUsed = ko.computed(function() { return me.minesTagged() === me.numMines(); });
		this.coveredTilesEqualMines = ko.computed(function() { return me.tilesCovered() === me.numMines(); });
		this.gameOver = ko.computed(function() { return me.success() || me.failure(); });
		...
		this.newGame = function() {
			if(me.gameIsValid()) {
				...
				var config = {columns: me.columns(), rows: me.rows(), numMines: me.numMines(), maxRows: me.maxRows, maxColumns: me.maxColumns};
