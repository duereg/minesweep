...
(function(ko, amplify, undefined) {
	...
	var gameViewModel = function(board, maxRows, maxColumns) {
		...
		function toggleTag(tileToToggle) {
			if(!me.cheating && !me.failure() && !me.success()) {
		...
		this.resetBoard = function() {
			if(me.gameIsValid()) {
				...
				amplify.publish(events.board.newGame, me.columns(), me.rows(), me.numMines());
			}
		};
