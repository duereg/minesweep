...
(function(ko, amplify, undefined) {
	...
	function mineViewModel(column, row) {
		...
		this.isMine = ko.computed(function() { return !this.isCovered() && !this.isTagged(); }, this); 

		this.disarm = function () {	this.armed(false); }.bind(this);
		this.explode = function() { this.uncover(false); }.bind(this);
